...
def buildCoursePrimary(initial_data):
    ...
    test_review = {
        ...
        "will_take_again": ["will_take_again"] or "",
        ...
        for dept, courses in all_descriptions.items():
            for crn, metadata in courses.items():
                course_and_review = {
                    ...
                    "department": dept,
                    "reviews": [test_review] if ["text"] else [],
                    "number_of_reviews": ["number_of_reviews"] or 0,
                    "sum_of_difficulty": ["sum_of_difficulty"] or 0,
                    "sum_of_organization": ["sum_of_organization"]
                    or 0,
