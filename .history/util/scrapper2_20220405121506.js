...
async function exampleAll() {
  ...
  try {
    ...
    const description = await driver.wait(
      until.elementLocated(
        By.xpath(
          `//*[@id="gateway-page"]/body/table/tbody/tr[3]/td[1]/table/tbody/tr[2]/td[1]/table/tbody/tr/td/table/tbody/tr[2]/td/div/div[12]/ul/li[3]/span/table/tbody/tr/td/div[2]`
        )
      )
    );
