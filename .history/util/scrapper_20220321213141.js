...
(async function example() {
  ...
  try {
    ...
    const each_dept_page = await driver
      ...
      .click();
    const crc_page = await driver.findElement(By.xpath("//*[@id="gateway-page"]/body/table/tbody/tr[3]/td[1]/table/tbody/tr[2]/td[1]/table/tbody/tr/td/table/tbody/tr[2]/td/div/div[12]/ul/li[1]/span/a")
