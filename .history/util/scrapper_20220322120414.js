...
async function exampleAll() {
  ...
  try {
    ...
    console.log(dept_nums.length);
    for (let i = 0; i < dept_nums.length; i++) {
      const crc_page = await driver
      .findElement(
        By.xpath(
          $`//*[@id="gateway-page"]/body/table/tbody/tr[3]/td[1]/table/tbody/tr[2]/td[1]/table/tbody/tr/td/table/tbody/tr[2]/td/div/div[12]/ul/li[${i+1}]/span/a`
        )
      )
      .click();
    ...
    const query = await driver.wait(
      until.elementLocated(
        By.xpath(
          `//*[@id="gateway-page"]/body/table/tbody/tr[3]/td[1]/table/tbody/tr[2]/td[1]/table/tbody/tr/td/table/tbody/tr[2]/td/div/div[12]/ul/li[1]/span/table/tbody/tr/td/div[2]`
     //*[@id="gateway-page"]/body/table/tbody/tr[3]/td[1]/table/tbody/tr[2]/td[1]/table/tbody/tr/td/table/tbody/tr[2]/td/div/div[14]/ul/li[1]/span/table/tbody/tr/td/div[2]
        )
      )
    );
    const query_text = await query.getText();
