...
def buildCoursePrimary(initial_data):
    ...
    test_review = {"text": initial_data["text"] or "", "likes": initial_data["likes"] or 0, "dislikes": initial_data["dislikes"] or 0, "will_take_again": initial_data["will_take_again"] or "Red", "professor": initial_data["professor"] or "", "semester": initial_data["semester"] or "", "name": initial_data["name"] or ""}
