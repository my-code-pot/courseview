...
async function exampleAll() {
  ...
  try {
    ...
    const dept_nums = await driver.findElement(
      By.xpath(
        `//*[@id="gateway-page"]/body/table/tbody/tr[3]/td[1]/table/tbody/tr[2]/td[1]/table/tbody/tr/td/table/tbody/tr[2]/td/div/div[12]/ul`
      )
    );
    const each_dept_page = await driver
      .findElement(
