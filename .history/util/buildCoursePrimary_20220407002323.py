...
def buildCoursePrimary(initial_data):
    ...
    test_review = {
        "text": hasatt["text"] or "",
        "likes": hasatt["likes"] or 0,
        "dislikes": hasatt["dislikes"] or 0,
        "will_take_again": hasatt["will_take_again"] or "",
        "professor": hasatt["professor"] or "",
        "semester": hasatt["semester"] or "",
        "name": hasatt["name"] or "",
    }
        ...
        for dept, courses in all_descriptions.items():
            for crn, metadata in courses.items():
                course_and_review = {
                    ...
                    "department": dept,
                    "reviews": [test_review] if hasatt["text"] else [],
                    "number_of_reviews": hasatt["number_of_reviews"] or 0,
                    "sum_of_difficulty": hasatt["sum_of_difficulty"] or 0,
                    "sum_of_organization": hasatt["sum_of_organization"]
                    or 0,
                    "sum_of_overall_quality": hasatt[
                        "sum_of_overall_quality"
                    ]
                    or 0,
                    "sum_of_will_take_again": hasatt[
