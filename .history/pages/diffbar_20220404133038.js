...
const diffbar = () => {
  ...
  const handleClick0 = (i) => {
      setClicked(clicked.map((clk, j) =>{
          if j<=i? !clicked[j]: clicked[false]
      }))
  };
  return (
    <Bar>
      <Left
        ...
        onClick={handleClick0(0)}
        clicked={clicked[0]}
      ></Left>
      <Middle
        hover_color={colors.middle1}
        onClick={handleClick0(1)}
        clicked={clicked[1]}
      ></Middle>
      <Middle
        hover_color={colors.middle2}
        onClick={handleClick0(2)}
        clicked={clicked[2]}
      ></Middle>
      <Middle
        hover_color={colors.middle3}
        onClick={handleClick0(3)}
        clicked={clicked[3]}
      ></Middle>
      <Right
        hover_color={colors.right}
        onClick={handleClick0(4)}
        clicked={clicked[4]}
      ></Right>
    </Bar>
  );
