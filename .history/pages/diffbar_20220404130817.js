...
const diffbar = () => {
  ...
  return (
    <Bar>
      <Left hover_color={colors.left} onClick={handleClick} clicked={clicked[0]}></Left>
      <Middle hover_color={colors.middle1} onClick={handleClick2} clicked={clicked=1}></Middle>
